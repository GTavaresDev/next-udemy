...
export function filterItemsByName(itens: Livro[], termo: string) {
...
export function filterItemsByCategory(itens: Livro[], categoria: string) {
  if (!categoria) {
    return itens;
  }
...
export function sortItemsByPrice(itens: Livro[], ordem: "asc" | "desc") {
